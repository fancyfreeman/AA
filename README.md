...
![[02 Attachments/Posted_Image_20250414135544.png|877]]
7类配置信息是：
...
- 数据分析师每月需要对公司的销售情况进行一次分析，指标数据来源如下：
	- 销售额（万元）、销售量（件）等9个指标，来自IT部门开发的销售报表，数据可以从报表系统下载使用。
		![[02 Attachments/Posted_Image_20250414143802.png|571]]
	- 各个门店的年营收计划值，是业务管理部门制定的，目前处于手工管理状态，以下是2024年各个门店的营收计划值，可用于计算计划完成率。
		![[02 Attachments/Posted_Image_20250414144128.png|403]]
	- 营收数据来自财务部门提供的手工报表，每月通过Excel发布，表格格式不规范，存在合并单元格。
		![[02 Attachments/Posted_Image_20250414144559.png|584]]
	- 数据分析周期为月。
...
![[02 Attachments/Posted_Image_20250415180111.png|714]]
...
![[02 Attachments/Posted_Image_20250414171710.png|650]]
模板采用yaml语法进行定义，包括head和sections两部分，其中sections可以嵌套sections，下面针对各项配置进行详细说明。
##### head部分
head用于定义模板的整体属性，如下图所示：
![[02 Attachments/Posted_Image_20250414172808.png|650]]
4个属性分别是
- title：分析报告的名称
...
![[02 Attachments/Posted_Image_20250414173116.png|650]]
##### 配置指标监测内容
...
````
运行结果如下：
![[02 Attachments/Posted_Image_20250415181620.png]]
